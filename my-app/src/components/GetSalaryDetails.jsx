...
const GetSalaryDetails = () => {
  ...
  <div className="inputs-container">
    ...
    <button onClick={getSalary}>Calculate</button>
  </div>

  
  <img className="salary-image" src={salaryy} alt="Salary Image" />
</div>
      ...
      {salaryDetails && (
        <div className="get-salary-details__salary-records">
          ...
          <button onClick={downloadPaySlip} className="payslipbutton">Download Pay Slip</button>
        </div>
      )}
    </div>
  );
